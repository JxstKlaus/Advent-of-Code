    ...
    while len(queue) > 0:
        ...
        for v_r, v_c in vectors:
            ...
            if 0<=neigh_r<ROWS and 0<=neigh_c<COLS:
                #The only change I made from part 1 is this if statement where I check for the parent node too
                if ((r,c),(neigh_r, neigh_c)) not in seen and map[neigh_r][neigh_c] - map[r][c] == 1:
                    queue.append((neigh_r,neigh_c))

print("Day 10 part 2:" ,scores)